...
# --- التنسيق البصري والخلفية المتحركة (الشبكة العصبية) ---
st.markdown("""
    <style>
    ...
    .radar-frame { 
        border: 2px solid #D4AF37; border-radius: 20px; background: rgba(0,0,0,0.95);
    ...
    <script>
        particlesJS('cyber-network-bg', {
            "particles": {
                ...
                "line_linked": { "enable": true, "distance": 150, "color": "#D4AF37", "opacity": 0.25, "width": 1.5 },
                "move": { "enable": true, "speed": 2.5, "direction": "none", "random": false, "out_mode": "out" }
            },
...
if st.button("تفعيل بروتوكول الكشف الجنائي الشامل"):
    if target_url:
        ...
        # 1. تحليل الكلمات الدلالية (Keywords)
